...
async function deleteAppointment(id, signal) {
    const res = await apiFetch(API.deleteAppointment(id), { method: "DELETE", signal });
                                        ...
                                        <Td>
                                            <button
                                                ...
                                                className={[
                                                    ...
                                                    "text-rose-700 ring-1 ring-inset ring-rose-200 bg-rose-50",
                                                    "hover:bg-rose-100 hover:ring-rose-300 hover:text-rose-800",
                                                    "active:scale-[.98] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-400",
                                                ].join(" ")}
                                                title="Delete reservation"
                                            >
                                                <svg viewBox="0 0 20 20" aria-hidden="true" className="h-4 w-4">
                                                    <path d="M7 2h6l1 2h3v2H3V4h3l1-2zm-1 6h2v8H6V8zm4 0h2v8h-2V8z" />
                                                </svg>
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    setAppointments((prev) => prev.filter((a) => a.id !== confirmId)); // optimistic
                                    try {
